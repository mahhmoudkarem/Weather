    ...
    weather.innerHTML = `<div class="col-md-4">
                <div class="card bg-dark text-white p-4 ">
                    ...
                    <div class="card-body">
                        ...
                        <p class="fw-bold text-primary">${data.current.condition.text}</p>
            ...
            <div class="col-md-4">
                <div class="card bg-dark text-white p-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="fw-bold text-primary">${data.forecast.forecastday[1].day.condition.text}</p>
            ...
            <div class="col-md-4">
                <div class="card bg-dark text-white p-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="fw-bold text-primary">${data.forecast.forecastday[2].day.condition.text}</p>
